...
#[DataModel_Definition(
	name: 'role_privilege',
	database_table_name: 'roles_developers_privileges',
	id_controller_class: DataModel_IDController_AutoIncrement::class,
	id_controller_options: ['id_property_name' => 'id'],
	parent_model_class: Auth_Developer_Role::class
)]
class Auth_Developer_Role_Privilege extends DataModel_Related_1toN implements Auth_Role_Privilege_Interface
{
